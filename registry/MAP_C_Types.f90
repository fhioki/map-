...
MODULE MAP_C_Types
  ...
  INTERFACE ! BEGIN: Interface to external C functions                             !          |     
     ...
     ! FUNCTION C_Create_MAP_InitOutput(msg,err) RESULT( this ) &          !          |     !          |
     !      !NAME = the C function called inside ' extern "C" '     !          |     !          |
     ...
     ! FUNCTION C_Create_MAP_Input(msg,err) RESULT( this ) &              !          |     !          |
     !      !NAME = the C function called inside ' extern "C" '     !          |     !          |
     ...
     ! !                                                            !          |     !          |
     ! ! Initalize input object                                     !          |     !          |
     ! FUNCTION C_Create_MAP_Parameter(msg,err) RESULT( this ) &          !          |     !          |
     !      !NAME = the C function called inside ' extern "C" '     !          |     !          |
     ...
     ! !                                                            !          |     !          |
     ! ! Initalize input object                                     !          |     !          |
     ! FUNCTION C_Create_MAP_Continuous(msg,err) RESULT( this ) &         !          |     !          |
     !      !NAME = the C function called inside ' extern "C" '     !          |     !          |
     ...
     ! !                                                            !          |     !          |
     ! ! Initalize input object                                     !          |     !          |
     ! FUNCTION C_Create_MAP_Discrete(msg,err) RESULT( this ) &           !          |     !          |
     !      !NAME = the C function called inside ' extern "C" '     !          |     !          |
     ...
     ! !                                                            !          |     !          |
     ! ! Initalize input object                                     !          |     !          |
     ! FUNCTION C_Create_MAP_Constraint(msg,err) RESULT( this ) &         !          |     !          |
     !      !NAME = the C function called inside ' extern "C" '     !          |     !          |
     ...
     ! !                                                            !          |     !          |
     ! ! Initalize input object                                     !          |     !          |
     ! FUNCTION C_Create_MAP_Output(msg,err) RESULT( this ) &             !          |     !          |
     !      !NAME = the C function called inside ' extern "C" '     !          |     !          |
...
CONTAINS
  ...
  ! SUBROUTINE MAP_InitOutput_Create( this,msg,err )
  !   TYPE( MAP_InitOutput_C ), INTENT( OUT ) :: this
  !   CHARACTER(KIND=C_CHAR) :: msg
  !   INTEGER(KIND=C_INT) :: err
  !   this%object = C_Create_MAP_InitOutput(msg,err)
  ...
  ! SUBROUTINE MAP_Input_Create( this,msg,err )
  !   TYPE( MAP_Input_C ), INTENT( OUT ) :: this
  !   CHARACTER(KIND=C_CHAR) :: msg
  !   INTEGER(KIND=C_INT) :: err
  !   this%object = C_Create_MAP_Input(msg,err)
  ...
  ! SUBROUTINE MAP_Param_Create( this,msg,err )
  !   TYPE( MAP_Param_C ), INTENT( OUT ) :: this
  !   CHARACTER(KIND=C_CHAR) :: msg
  !   INTEGER(KIND=C_INT) :: err
  !   this%object = C_Create_MAP_Parameter(msg,err)
  ...
  ! SUBROUTINE MAP_ContState_Create( this,msg,err )
  !   TYPE( MAP_ContState_C ), INTENT( OUT ) :: this
  !   CHARACTER(KIND=C_CHAR) :: msg
  !   INTEGER(KIND=C_INT) :: err
  !   this%object = C_Create_MAP_Continuous(msg,err)
  ...
  ! SUBROUTINE MAP_DiscState_Create( this,msg,err )
  !   TYPE( MAP_DiscState_C ), INTENT( OUT ) :: this
  !   CHARACTER(KIND=C_CHAR) :: msg
  !   INTEGER(KIND=C_INT) :: err
  !   this%object = C_Create_MAP_Discrete(msg,err)
  ...
  ! SUBROUTINE MAP_ConstrState_Create( this,msg,err )
  !   TYPE( MAP_ConstrState_C ), INTENT( OUT ) :: this
  !   CHARACTER(KIND=C_CHAR) :: msg
  !   INTEGER(KIND=C_INT) :: err
  !   this%object = C_Create_MAP_Constraint(msg,err)
  ...
  ! SUBROUTINE MAP_Output_Create( this,msg,err )
  !   TYPE( MAP_Output_C ), INTENT( OUT ) :: this
  !   CHARACTER(KIND=C_CHAR) :: msg
  !   INTEGER(KIND=C_INT) :: err
  !   this%object = C_Create_MAP_Output(msg,err)
