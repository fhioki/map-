	...
	integer *n2, integer *n3, integer *n4)
{
    ...
    integer nbmin;
    logical sname;
    /* @mdm LAPACK/SRC/ieeeck.c extern */ integer ieeeck_(integer *, real *, real *);
    char subnam[1];
    /* @mdm LAPACK/SRC/iparmq.c extern */ integer iparmq_(integer *, char *, char *, integer *, integer *, integer *, integer *);
