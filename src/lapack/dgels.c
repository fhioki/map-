	...
	doublereal *work, integer *lwork, integer *info)
{
    ...
    logical tpsd;
    integer iascl, ibscl;
    /* @mdm BLAS/SRC/lsame.c extern */ logical lsame_(char *, char *);   
    integer wsize;
    doublereal rwork[1];
    /* @mdm LAPACK/SRC/dlabad.c extern */ /* Subroutine */ int dlabad_(doublereal *, doublereal *);
    /* @mdm INSTALL/dlamch.c extern */ doublereal dlamch_(char *);
    /* @mdm LAPACK/SRC/dlange.c extern */ doublereal dlange_(char *, integer *, integer *, doublereal *, integer *, doublereal *);
    /* @mdm LAPACK/SRC/dgelqf.c extern */ /* Subroutine */ int dgelqf_(integer *, integer *, doublereal *, integer *, doublereal *, doublereal *, integer *, integer *);
    /* @mdm LAPACK/SRC/dlascl.c extern */ int dlascl_(char *, integer *, integer *, doublereal *, doublereal *, integer *, integer *, doublereal *, integer *, integer *);
    /* @mdm LAPACK/SRC/dgeqrf.c extern */ int dgeqrf_(integer *, integer *, doublereal *, integer *, doublereal *, doublereal *, integer *, integer *);
    /* @mdm LAPACK/SRC/dlaset.c extern */ int dlaset_(char *, integer *, integer *, doublereal *, doublereal *, doublereal *, integer *);
    /* @mdm BLAS/SRC/xerbla.c extern */ int xerbla_(char *, integer *);
    /* @mdm LAPACK/SRC/ilaenv.c extern */ integer ilaenv_(integer *, char *, char *, integer *, integer *, integer *, integer *);
    integer scllen;
    doublereal bignum;
    /* @mdm LAPACK/SRC/dormlq.c extern */ /* Subroutine */ int dormlq_(char *, char *, integer *, integer *, integer *, doublereal *, integer *, doublereal *, doublereal *, integer *, doublereal *, integer *, integer *);
    /* @mdm LAPACK/SRC/dormqr.c extern */ int dormqr_(char *, char *, integer *, integer *, integer *, doublereal *, integer *, doublereal *, doublereal *, integer *, doublereal *, integer *, integer *);
    doublereal smlnum;
    logical lquery;
    /* @mdm LAPACK/SRC/dtrtrs.c extern */ /* Subroutine */ int dtrtrs_(char *, char *, char *, integer *, integer *, doublereal *, integer *, doublereal *, integer *, integer *);
