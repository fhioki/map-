	...
	doublereal *work, integer *ldwork)
{
    ...
    /* Local variables */
    integer i__, j;
    /* @mdm BLAS/SRC/dgemm.c extern */ /* Subroutine */ int dgemm_(char *, char *, integer *, integer *, integer *, doublereal *, doublereal *, integer *, doublereal *, integer *, doublereal *, doublereal *, integer *);
    /* @mdm BLAS/SRC/lsame.c extern */ logical lsame_(char *, char *);
    integer lastc;
    /* @mdm BLAS/SRC/dcopy.c extern */ /* Subroutine */ int dcopy_(integer *, doublereal *, integer *, doublereal *, integer *);
    /* @mdm BLAS/SRC/dtrmm.c extern */ int dtrmm_(char *, char *, char *, char *, integer *, integer *, doublereal *, doublereal *, integer *, doublereal *, integer *);
    integer lastv;
    /* @mdm LAPACK/SRC/iladlc.c extern */ integer iladlc_(integer *, integer *, doublereal *, integer *);
    /* @mdm LAPACK/SRC/iladlr.c extern */ integer iladlr_(integer *, integer *, doublereal *, integer *);
    char transt[1];
